...
$(document).ready(function(){
	$(".mixCategory").click(function(){
		var map;
		var placeName = $(".mixCategory").children().first().children().first().next().children().children().html();
		var placeX = $(".mixCategory").children().first().children().first().next().children().children().first().next().val();
