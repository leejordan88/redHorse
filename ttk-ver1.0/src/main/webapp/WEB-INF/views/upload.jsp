...
<!-- Dropzone.js -->
<link
	href="${pageContext.request.contextPath}/resources/vendors/dropzone/dist/min/dropzone.min.css"
	rel="stylesheet">
<body>
	<br>
	<br>
	...
	<form action="${pageContext.request.contextPath}/uploadMemberPic.do"
		...
		제목   <input type="text" id="title" name="title" size="48"><br>
		작성자 ${sessionScope.mvo.name} <br>
		내용 <br><textarea cols="33" rows="15" id="content" name="content"></textarea><br>
