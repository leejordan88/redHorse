...
//
   ...
   public PagingBeanVO(MessageVO messageVO, int totalContents, int nowPage) {
      this.nowPage = nowPage;
      this.totalContents = totalContents;
      this.messageVO = messageVO;
   ...
   public static void main(String args[]) {
      ...
      PagingBeanVO p = new PagingBeanVO(vo,47, 10);
...
//전체 페이지 수 : 10
   ...
   System.out.println("////////////////////////////");
   p = new PagingBeanVO(vo,31, 6);// 게시물수 31 현재 페이지 6
...
//
   ...
   public PagingBeanVO(int nowPage, int totalContents) {
      super();
      this.nowPage = nowPage;
      this.totalContents = totalContents;
   }
