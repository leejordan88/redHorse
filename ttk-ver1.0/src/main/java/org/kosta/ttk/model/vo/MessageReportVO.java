...
public class MessageReportVO {
   ...
   public MessageReportVO(int messageReportNo, String messageReportDate, int messageReportState,  String messageReportContent,MessageVO messageVO) {
      super();
...
public int getMessageReportNo() {
   ...
   public String toString() {
      return "MessageReportVO [messageReportNo=" + messageReportNo + ", messageReportDate=" + messageReportDate
            + ", messageReportState=" + messageReportState + ", messageVO=" + messageVO + "]";
   }   
}